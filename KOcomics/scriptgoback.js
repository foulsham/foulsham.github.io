      ...
      "template": {
        ...
        "content": [
              ...
              
		  {
			...
			"parameters":{"p":1}, //keep track of panel count
			...
			'events': {"keypress(Space)": function(event) { //we'll call this function to go to next panel
						...
						"keypress(ArrowLeft)": function(event) { //we'll call this to go back a panel
      					p=this.parameters.p-1
      					this.parameters.p=p
      					switch (p) { //depending on the current panel set the new one

 ...
 * 
 * TF changed 8/2017
 * Changed label to "submit answer"
 * now only continues on button press when we have an answer
 */
...
(function($) {
  jsPsych['survey-likert'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      for (var i = 0; i < trial.questions.length; i++) {
        ...
        $("#jspsych-survey-likert-slider-" + i).slider({
		  ...
		  change: function(event, ui) {
			...
			$("#jspsych-survey-likert-next").prop('disabled',false);
		  }          
        });
      ...
      $("#jspsych-survey-likert-next").prop('disabled',true);
